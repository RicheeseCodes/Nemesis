--[[
    Nemesis UI — a fork of Rayfield Interface Suite.

    Upstream:   https://github.com/SiriusSoftwareLtd/Rayfield
    License:    Apache License 2.0 (see LICENSE)
    Fork:       https://github.com/siriusxcontact/Nemesis
    Authored by siriusxcontact, with permission from Jenson (Rayfield maintainer).

    The Rayfield credits and notice block follow below, preserved from upstream.
]]
